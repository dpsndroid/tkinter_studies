...
#----------------------------------------------------------------------------------
        ...
        self.canvas_bt.place(relx=0.0, rely=0.13, relwidth=1.0, relheight=0.22)
# button limpar
...
# button buscar
        self.bt_search = Button(self.aba1, text="Buscar", bd=2, bg="lightgrey", fg="darkgreen", activebackground="darkgrey", activeforeground="white", font= ("verdana", 10, "bold"), command=self.search_client)
...
#---------------------------------------------------------------------------------
        self.lb_code = Label(self.aba1, text="Código", background="lightgrey", fg="darkgreen", font= ("verdana", 10, "bold"))
        
        self.lb_code.place(relx=0.05, rely=0.01)

        self.code_entry = Entry(self.aba1, bg="lightgreen", fg="darkgreen", font= ("verdana", 10, "bold"))
