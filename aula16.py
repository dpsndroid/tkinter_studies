...
# button emoji
        self.bt_emoji = ttk.Button(self.frame1, style= "BW.TButton")
# Inserting image
        self.imgnew = PhotoImage(file = "neutral-face.png")
        self.imgnew = self.imgnew.subsample(5, 5) #size of the image
        self.style = ttk.Style()
        self.style.configure("BW.TButton", relwidth=1, relheigth=1, foreground="grey", borderwidth=0, bordercolor= "grey", image=self.imgnew)


        self.bt_emoji.place(relx=0.47, rely=0.15, relwidth=0.1, relheight=0.15)
